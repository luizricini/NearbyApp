...
class PlaceTableViewCell: UITableViewCell {
    ...
    private func setupConstraints() {
        NSLayoutConstraint.activate([
            ...
            contentView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: 8),
            ...
            itemImageView.bottomAnchor.constraint(equalTo: topAnchor, constant: -8),
    ...
    func configure(with place: Place) {
        ...
        ticketLabel.text = "\(place.coupons) available coupons"
    }
}
