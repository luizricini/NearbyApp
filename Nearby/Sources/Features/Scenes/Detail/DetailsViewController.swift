...
class DetailsViewController: UIViewController {
    ...
    private let regulationLabel: UILabel = {
        ...
        let regulationText = """
        • Valid for in-person consumption only
        • Available until 31/01/2025
        """
    ...
    private let qrCodeButton: UIButton = {
        ...
        button.setTitle("Read QR Code", for: .normal)
    ...
    private func configureDetails(){
        ...
        infoStackView.addArrangedSubview(createInfoRow(iconName: "ticket", text: "\(place.coupons) available coupons"))
